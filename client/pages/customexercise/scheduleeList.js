...
const scheduleeList=({schedulee,onExerciseSchedule,deleteDayE})=>{
	...
	const onView=(e)=>{
		...
		setShowDetailsCard(days[dates.findIndex(sameDay)].map((x)=>{return <CardDetails  exercise={x.exercise} id={x.sameExercise} key={x.sameExercise+Math.random()} />}))
